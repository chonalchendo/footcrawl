...
@pytest.mark.asyncio
async def test_match_lineups_parser(
    match_lineups_html_sample: str, match_lineups_parser_url: str
):
    ...
    assert (
        result["season_stats_link"]
        == "/andre-onana/leistungsdatendetails/spieler/234509/saison/2024/wettbewerb/GB1"
    )
