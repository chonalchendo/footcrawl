...
class AsyncMatchStatsCrawler(base.Crawler):
    KIND: T.Literal["match_stats"] = "match_stats"

    seasons: list[int]
    matchday: str
    parser: parsers.MatchStatsParser = pdt.Field(
        default_factory=parsers.MatchStatsParser
    )
